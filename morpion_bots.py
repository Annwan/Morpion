...
class SmartBot(Bot):
    ...
    def block_opp(self):
        ...
        if (A1 == A2 and A1 != 0 or C1 == B2 and
           C1 != 0 or B2 == B3 and B2 != 0) and A3 == 0:
            return 2, 0
        elif (A1 == A3 and A1 != 0 or B2 == C2 and B2 != 0) and A2 == 0:
            return 1, 0
        elif (A2 == A3 and A2 != 0 or B2 == C3 and
              B2 != 0 or B1 == C1 and B1 != 0) and A1 == 0:
            return 0, 0
        elif (A3 == C3 and A3 != 0 or B1 == B2 and B1 != 0) and B3 == 0:
            return 2, 1
        elif (B1 == B3 and B1 != 0 or A2 == C2 and A2 != 0 or C1 == A3 and
              C1 != 0 or A1 == C3 and A1 != 0) and B2 == 0:
            return 1, 1
        elif (B2 == B3 and B2 != 0 or C1 == A1 and A1 != 0) and B1 == 0:
            return 0, 1
        elif (C1 == C2 and C1 != 0 or A3 == B3 and A3 != 0 or A1 == B2 and
              A1 != 0) and C3 == 0:
            return 2, 2
        elif (C1 == C3 and C1 != 0 or A2 == B2 and A2 != 0) and C2 == 0:
            return 1, 2
        elif (C2 == C3 and C2 != 0 or B2 == A3 and
              B2 != 0 or A1 == B1 and B1 != 0) and C1 == 0:
            return 0, 2
        else:
            return None, None
